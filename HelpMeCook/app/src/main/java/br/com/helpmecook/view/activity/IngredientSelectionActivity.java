...
public class IngredientSelectionActivity extends ActionBarActivity {
    ...
    private int wantedIngredients[];
    private int unwantedIngredients[];
...
//        View header = (View)getLayoutInflater().inflate(R.layout.ingredient_selection_activity, null);
//        lvList.addHeaderView(header);
    ...
    public void buttonClick(View view){
        if (origin == MainActivity.MAIN) {
            ...
            wantedIngredients = new int[allIngredients.size()];
            Intent intent = getIntent();
    ...
    private void executeSearch(){
        wantedIngredients = new int[allIngredients.size()];
        unwantedIngredients = new int[allIngredients.size()- wantedIngredients.length];
        ...
        for (int i=0; i<clicked.size(); i++){
            ...
            if (clicked.get(i)==2){
                unwantedIngredients[i] = allIngredients.get(i).getId();
            }
        }
